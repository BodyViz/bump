...
/**
 * A public runtime error class which is used when the notification center is
 * used incorrectly. This can either involve shutting down the notification
 * center without properly removing all the observers as well as incorrectly
