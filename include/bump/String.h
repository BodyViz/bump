...
typedef std::vector<String>
    StringList; /**< A shortcut typedef for an std::vector of bump::String
                   objects. */
typedef std::set<String> StringSet; /**< A shortcut typedef for an std::set of
                                       bump::String objects. */

/**
 * A string class which adds lots of useful string methods ontop of the
 * std::string class. These methods range from custom print methods for many
 * different types of objects as well as string methods common in both Python
 * and Objective-C. This class was developed to eliminate the pain of string
...
public:
    ...
    enum CaseSensitivity {
        CaseSensitive = 0, /**< Case sensitive meaning that 'xyz' and 'XYZ' are
                              different. */
        NotCaseSensitive = 1 /**< NOT case sensitive meaning that 'xyz' and
                                'XYZ' are the same. */
    };
     ...
     * @endcode
     *
     * @throw bump::StringSearchError When no valid valid markers are found
     * (i.e. %1-%99).
     *
     ...
     *
     * @throw bump::OutOfRangeError When position is outside this string's
     * bounds.
     *
     ...
     *
     * @param otherString The string to compare content against with this
     * string.
     * @param caseSensitivity The case sensitivity to be used, defaults to
     * CaseSensitive.
     ...
     * Compares the content of the this string with the given string.
     *
     * @param otherString The const char* to compare content against with this
     * string.
     * @param caseSensitivity The case sensitivity to be used, defaults to
     * CaseSensitive.
     * @return Whether the content within both objects is the same.
     ...
     *
     * @param containString The String to see if is contained within this
     * string.
     * @param caseSensitivity The case sensitivity to be used, defaults to
     * CaseSensitive.
     ...
     * Finds out whether this string contains an occurrence of the given string.
     *
     * @param containString The const char* to see if is contained within this
     * string.
     * @param caseSensitivity The case sensitivity to be used, defaults to
     * CaseSensitive.
     * @return True if the string contains an occurrence of containString,
     ...
     * from -1 (default), the string is resized to size beforehand.
     *
     * @throw bump::InvalidArgumentError When passed a character string with
     ...
     * by searching forward from the startPosition.
     *
     * @throw bump::InvalidArgumentError When passed an empty index string.
     *
     * @param indexString The String to find the first occurence of in this
     * string.
     ...
     * @throw bump::InvalidArgumentError When passed an empty index string.
     *
     * @param indexString The const char* to find the first occurence of in this
     * string.
     * @param startPosition The index of the string to start searching at.
     * @param caseSensitivity The case sensitivity to be used, defaults to
     * CaseSensitive.
     ...
     * @param insertString The String to insert at the given index position in
     * this string.
     * @return A reference to the modified string.
     */
     ...
     *
     * @param position The index position of the string to start inserting at.
     * @param insertString The const char* to insert at the given index position
     * in this string.
     * @return A reference to the modified string.
     */
     ...
     * by searching backwards from the startPosition. If startPosition is -1
     * (default), the search starts at the last character.
     *
     * @throw bump::InvalidArgumentError When passed an empty index string.
     *
     * @param indexString The string to find the last occurence of in this
     * string.
     * @param startPosition The index of the string to start searching at.
     * @param caseSensitivity The case sensitivity to be used, defaults to
     * CaseSensitive.
     ...
     * @throw bump::InvalidArgumentError When passed an empty index string.
     *
     * @param indexString The const char* to find the last occurence of in this
     * string.
     * @param startPosition The index of the string to start searching at.
     * @param caseSensitivity The case sensitivity to be used, defaults to
     * CaseSensitive.
     ...
     * Adds the given string to the beginning of this string.
     *
     * @param prependString The const char* to add to the beginning of this
     * string.
     * @return The modified version of this string.
     */
     ...
     *
     * @param position The index position to start removing characters at from
     * this string.
     ...
     * @param replaceString The string to replace the n characters in this
     * string.
     * @return The modified version of this string.
     */
     ...
     * @param position The index of this string to start replacing at.
     * @param n The number of characters to replace in this string.
     * @param replaceString The const char* to replace the n characters in this
     * string.
     * @return The modified version of this string.
     */
     ...
     *
     * @param startPosition The starting position in this string to begin the
     * section.
     ...
     * separator string.
     *
     * @param separator A string used to split the string into a list of
     * strings.
     ...
     *
     * @throw bump::TypeCastError When this string cannot be converted to a
     * boolean.
     *
     ...
     *
     * @throw bump::TypeCastError When this string cannot be converted to an
     * int.
     *
