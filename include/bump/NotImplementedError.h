...
/**
 * A public runtime error class which is used when a function or method simply
 * has not yet been implemented and should not be used. This will generally be
 * the case when there is cross-platform code that has not yet been properly
 * implemented on one of the platforms.
 */
