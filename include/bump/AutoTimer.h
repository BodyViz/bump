...
public:
    /**
     * Defines the possible types of output formatting to be printed to
     * std::cout.
     */
    enum OutputType {
...
protected:
    ...
    OutputType _outputType; /**< @internal The output format to be printed to
                               std::cout. */
    Timer
        _timer; /**< @internal The timer used to print out the elapsed time. */
};
