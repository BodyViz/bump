 ...
 *
 * It is broken up into the following sections to make it easier to find out
 ...
 *		Section 4 - Manipulation (prepend, append, remove, chop,
 * trimmed) Section 5 - Extraction (section, left, right) Section 6 -
...
void creationAndCasting() {
    ...
    // These strings can even be created with floats and doubles. The precision
    // in the string will be the same as passed into the function.
    ...
    std::cout << "- Double:\n\t- Value:  " << std::setprecision(11)
              << value_double << "\n\t- String: " << str_double << std::endl;

    // You can even specify the precision for the floats and doubles. The
    // bump::String class will handle all the rounding properly as you can see
    // below.
    ...
    std::cout << "- Float:\n\t- Value:  " << value_float
              << "\n\t- String: " << str_float_precise << " Precision: " << 2
              << std::endl;
    std::cout << "- Double:\n\t- Value:  " << std::setprecision(11)
              << value_double << "\n\t- String: " << str_double_precise
...
void formatting() {
    ...
    std::cout << "\nConcatenating strings together with << operator:"
              << std::endl;
    bump::String str("bump");
    str << bump::String(" strings ") << "are " << "really cool!!!";
    std::cout << "- Concatenated String: " << str << std::endl;

    // You can even use the << operator to concatenate numbers and booleans into
    // the string
    std::cout << "\nConcatenating strings, numbers and booleans together with "
                 "<< operator:"
              << std::endl;
    str = "Processing";
    ...
    // You can also use the arg methods to format strings. The way this works is
    // that you specify a marker between 1 and 99 (i.e. %1-%99) and the arg
    // method will replace the lowest marker (i.e. %5) with the given argument.
    std::cout << "\nConcatenating strings together with arg method:"
              << std::endl;
    ...
    // Wouldn't it be really cool if the arg method also supported numbers and
    // booleans?
    std::cout << "\nStrings, numbers and booleans as arg method parameters:"
              << std::endl;
    ...
    str = orig_str.arg(20.9987, true, "\"awesome\"", -174354,
                       bump::String("\"why not\""), std::string("\"works\""));
    std::cout << "- Original String:     " << orig_str << std::endl;
    std::cout << "- Replaced String:     " << str << std::endl;

    // Sometimes you need to pad a string with a character or another string to
    // make sure it's a certain length. If you need to do this, the
    // padWithString method can be used.
...
void comparison() {
    ...
    std::cout << "\nComparing if two strings are equal with the == operator:"
              << std::endl;
    bump::String str1("string 1");
    bump::String str2("string 1");
    bump::String are_equal = str1 == str2;
    std::cout << "- \"" << str1 << "\" == \"" << str2 << "\" : " << are_equal
              << std::endl;
    str1 = "string 1";
    str2 = "string 2";
    are_equal = str1 == str2;
    ...
    // The == operator is nice when the comparison is case sensitive, but what
    // if we don't actually care about case? This is where the
    // bump::String::compare method comes in.
    std::cout << "\nComparing if two strings are equal with the compare method:"
              << std::endl;
    str1 = "string 1";
    str2 = "string 1";
    ...
    // Another useful comparison is to know whether a string starts with a
    // different string
    std::cout << "\nComparing if a string starts with another string:"
              << std::endl;
    str1 = "What does this string start with?";
    str2 = "what";
    bump::String starts_with =
        str1.startsWith(str2, bump::String::CaseSensitive);
    std::cout << "- Does \"" << str1 << "\" start with \"" << str2
              << "\" : " << starts_with << " : Case Sensitive" << std::endl;
    starts_with = str1.startsWith(str2, bump::String::NotCaseSensitive);
    std::cout << "- Does \"" << str1 << "\" start with \"" << str2
              << "\" : " << starts_with << " : Not Case Sensitive" << std::endl;

    // Another useful comparison is to know whether a string ends with a
    // different string
    std::cout << "\nComparing if a string ends with another string:"
              << std::endl;
    str1 = "Do I end with this?";
    str2 = "THIS?";
    bump::String ends_with = str1.endsWith(str2, bump::String::CaseSensitive);
    std::cout << "- Does \"" << str1 << "\" end with \"" << str2
              << "\" : " << ends_with << " : Case Sensitive" << std::endl;
    ends_with = str1.endsWith(str2, bump::String::NotCaseSensitive);
    std::cout << "- Does \"" << str1 << "\" end with \"" << str2
              << "\" : " << ends_with << " : Not Case Sensitive" << std::endl;
}
...
void manipulation() {
    ...
    std::cout << "- \"" << str1 << "\" prepended with \"" << str2
              << "\" equals \"";
    str1.prepend(str2);
    ...
    std::cout << "- \"" << str1 << "\" appended with \"" << str2
              << "\" equals \"";
    str1.append(str2);
    std::cout << str1 << "\"" << std::endl;
    ...
    str2 = "simple ";
    std::cout << "- Removing \"" << str2 << "\" from \"" << str1
              << "\" equals \"";
    str1.remove(str2);
    std::cout << str1 << "\"" << std::endl;
    str1 = "This is a simple string";
    std::cout << "- Removing the first 8 characters of \"" << str1
              << "\" equals \"";
    str1.remove(0, 8);
    std::cout << str1 << "\"" << std::endl;

    // How to chop off characters from the end of a string
    std::cout << "\nChopping off characters from the end of a string:"
              << std::endl;
    str1 = "Be sure to go to the movies";
    std::cout << "- Chopping off the last 14 character of \"" << str1
              << "\" equals \"";
    str1.chop(14);
    std::cout << str1 << "\"" << std::endl;
    ...
    std::cout
        << "\nTrimming off whitespace from the beginning and end of a string:"
        << std::endl;
...
void extraction() {
    ...
    std::cout << "- Extracting all characters starting at position 11 from \""
              << str1 << "\" equals \"";
    bump::String str2 = str1.section(11);
    std::cout << str2 << "\"" << std::endl;
    str1 = "Processing File 1 of 20: test.txt";
    std::cout << "- Extracting 7 characters starting at position 16 from \""
              << str1 << "\" equals \"";
    ...
    std::cout << "- Extracting 6 characters from the left side of \"" << str1
              << "\" equals \"";
    str2 = str1.left(6);
    std::cout << str2 << "\"" << std::endl;
    ...
    str1 = "<node>testing</node>";
    std::cout << "- Extracting 7 characters from the right side of \"" << str1
              << "\" equals \"";
    str2 = str1.right(7);
    std::cout << str2 << "\"" << std::endl;
}
...
void capitalization() {
    ...
    // How to capitalize all the words in a string (the first character and any
    // following a space)
    std::cout << "\nCapitalizing all words like a title of a book:"
              << std::endl;
...
void findReplace() {
    ...
    std::cout << "- Where is \"" << str2 << "\" in \"" << str1
              << "\" : " << index << std::endl;
    ...
    std::cout << "\nFinding the last index of a string inside another string:"
              << std::endl;
    str1 = "i drove down the runway";
    str2 = "e";
    index = str1.lastIndexOf(str2);
    std::cout << "- Where is the last \"" << str2 << "\" in \"" << str1
              << "\" : " << index << std::endl;
    ...
    std::cout << "\nReplacing a specified section of another string:"
              << std::endl;
    str1 = "i drove down the runway";
    str2 = "with my eyes closed";
    std::cout << "- Replacing 15 characters at position 8 in \"" << str1
              << "\" with \"" << str2 << "\" equals \"";
    ...
    std::cout << "- Replacing \"" << str2 << "\" with \"" << str3 << "\" in \""
              << str1 << "\" equals \"";
...
void joinSplit() {
    ...
    std::cout << "- Splitting \"" << str1 << "\" with \"" << str2
              << "\" equals:";
    ...
    std::cout << " with \" \" into a single string equals \"" << str1 << "\""
              << std::endl;
}
