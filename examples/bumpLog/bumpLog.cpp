...
/**
 * Runs the bump::Log in parallel across two different threads to demonstrate
 * the thread-safety of the logging system.
 */
...
int main() {
    ...
    bumpALWAYS(bump::String("\nPushing messages with a custom prefix: \"")
               << customDashPrefix << "\"");
    ...
    bumpALWAYS_P(customPrefix,
                 "Example prefix message with \"DATE_TIME_TIMESTAMP\" "
                 "timestamp formatting\n");
    ...
    bumpALWAYS(
        ...
        "formatting");
    bumpALWAYS_P(customPrefix,
                 "Example prefix message with \"TIME_WITHOUT_AM_PM_TIMESTAMP\" "
                 "timestamp formatting\n");
