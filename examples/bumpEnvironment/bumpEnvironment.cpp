 ...
 *
 * The Bump Environment class is designed to make it easy to work with
...
int main(int argc, char** argv) {
    ...
    bump::Environment::setEnvironmentVariable("BUMP_HOME", bump_home_value,
                                              true);
    std::cout << "- Set \"BUMP_HOME\" to \"" << bump_home_value << "\""
              << std::endl;
    bump::String bump_output_file_value("output.txt");
    bump::Environment::setEnvironmentVariable("BUMP_OUTPUT_FILE",
                                              bump_output_file_value);
    std::cout << "- Set \"BUMP_OUTPUT_FILE\" to \"" << bump_output_file_value
              << "\"" << std::endl;

    // How to fetch environment variable values
    std::cout << "\nFetching environment variables:" << std::endl;
    bump::String bump_home =
        bump::Environment::environmentVariable("BUMP_HOME");
    std::cout << "- \"BUMP_HOME\" is \"" << bump_home << "\"" << std::endl;
    bump::String bump_output_file =
        bump::Environment::environmentVariable("BUMP_OUTPUT_FILE");
    std::cout << "- \"BUMP_OUTPUT_FILE\" is \"" << bump_output_file << "\""
              << std::endl;
