...
int main() {
    ...
    bump::Uuid uuid1 =
        bump::Uuid::fromString("4605d211-2d5b-4ab4-8feb-d7c38e4e38c3");
    bump::Uuid uuid2 =
        bump::Uuid::fromString("c9226c75-2e16-4bad-bd27-f4b782869dfb");
    std::cout << "- UUID fromString: \"" << uuid1.toString() << "\""
              << std::endl;
    std::cout << "- UUID fromString: \"" << uuid2.toString() << "\""
              << std::endl;

    // How to create strings from uuids
    std::cout << "\nCreating strings from uuids:" << std::endl;
    bump::String uuid_str1 =
        bump::Uuid::fromString("4605d211-2d5b-4ab4-8feb-d7c38e4e38c3")
            .toString();
    bump::String uuid_str2 =
        bump::Uuid::fromString("c9226c75-2e16-4bad-bd27-f4b782869dfb")
            .toString();
    ...
    bump::Uuid uuid5 =
        bump::Uuid::fromString("00000000-0000-0000-0000-000000000000");
    bump::Uuid uuid6 =
        bump::Uuid::fromString("c9226c75-2e16-4bad-bd27-f4b782869dfb");
    std::cout << "- Is \"" << uuid3.toString()
              << "\" null: " << bump::String(uuid3.isNull()) << std::endl;
    std::cout << "- Is \"" << uuid4.toString()
              << "\" null: " << bump::String(uuid4.isNull()) << std::endl;
    std::cout << "- Is \"" << uuid5.toString()
              << "\" null: " << bump::String(uuid5.isNull()) << std::endl;
    std::cout << "- Is \"" << uuid6.toString()
              << "\" null: " << bump::String(uuid6.isNull()) << std::endl;
    ...
    std::cout << "- Are \"" << uuid1.toString() << "\" and \""
              << uuid2.toString()
              << "\" equal : " << bump::String(uuid1 == uuid2) << std::endl;
    std::cout << "- Is \"" << uuid1.toString() << "\" less than \""
              << uuid2.toString() << "\" : " << bump::String(uuid1 < uuid2)
              << std::endl;
    std::cout << "- Is \"" << uuid1.toString() << "\" greater than \""
              << uuid2.toString() << "\" : " << bump::String(uuid1 > uuid2)
              << std::endl;
