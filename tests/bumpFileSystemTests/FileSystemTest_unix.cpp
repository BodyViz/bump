...
TEST_F(FileSystemTest, testSetPermissions) {
    ...
    EXPECT_TRUE(bump::FileSystem::setPermissions("unittest/files/output.txt",
                                                 permissions));
    bump::FileSystem::Permissions actual_permissions =
        bump::FileSystem::permissions("unittest/files/output.txt");
    ...
    permissions = (bump::FileSystem::OWNER_READ |
                   bump::FileSystem::OWNER_WRITE | bump::FileSystem::OWNER_EXE);
    EXPECT_TRUE(
        bump::FileSystem::setPermissions("unittest/files", permissions));
    ...
    EXPECT_FALSE(bump::FileSystem::setPermissions(
        "unittest/files/not_valid.txt", permissions));

    // Set permissions on an invalid directory
    EXPECT_FALSE(
        bump::FileSystem::setPermissions("unittest/not valid", permissions));
}

TEST_F(FileSystemTest, testPermissions) {
    // Get the permissions of a valid file
    bump::FileSystem::Permissions permissions =
        (bump::FileSystem::OWNER_READ | bump::FileSystem::OWNER_WRITE |
         bump::FileSystem::GROUP_READ | bump::FileSystem::OTHERS_READ);
    EXPECT_TRUE(bump::FileSystem::setPermissions("unittest/files/output.txt",
                                                 permissions));
    ...
    permissions = (bump::FileSystem::OWNER_ALL | bump::FileSystem::GROUP_READ |
                   bump::FileSystem::GROUP_EXE | bump::FileSystem::OTHERS_READ |
    ...
    EXPECT_THROW(bump::FileSystem::permissions("unittest/files/not_valid.txt"),
                 bump::FileSystemError);

    // Set permissions on an invalid directory
    EXPECT_THROW(bump::FileSystem::permissions("unittest/not valid"),
                 bump::FileSystemError);
}
...
TEST_F(FileSystemTest, testSetIsReadableByOwner) {
    ...
    bump::FileSystem::Permissions permissions =
        bump::FileSystem::permissions(path);
