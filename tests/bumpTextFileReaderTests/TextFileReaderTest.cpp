...
/**
 * This is our main TextFileReader testing class. The SetUp and TearDown methods
...
TEST_F(TextFileReaderTest, testValidityOfFile) {
    ...
    bump::StringList entire_file =
        bump::TextFileReader::fileContents(_validFileName);
    ...
    EXPECT_TRUE(entire_file.empty());
    entire_file =
        bump::TextFileReader::fileContents(_nonsensicalFileName, 1, 1);
    EXPECT_TRUE(entire_file.empty());
...
TEST_F(TextFileReaderTest, testReadEntireFile) {
    ...
    bump::StringList entire_file =
        bump::TextFileReader::fileContents(_validFileName);
    EXPECT_STREQ("1: This is the first line",
                 entire_file.at(0).toStdString().c_str());
    EXPECT_STREQ("2: This is the second line",
                 entire_file.at(1).toStdString().c_str());
    EXPECT_STREQ("3: This is the third line",
                 entire_file.at(2).toStdString().c_str());
    EXPECT_STREQ("4: This is the fourth line",
                 entire_file.at(3).toStdString().c_str());
    EXPECT_STREQ("5: This is the fifth line",
                 entire_file.at(4).toStdString().c_str());
    EXPECT_STREQ("6: This is the sixth line",
                 entire_file.at(5).toStdString().c_str());
    EXPECT_STREQ("7: This is the seventh line",
                 entire_file.at(6).toStdString().c_str());
    EXPECT_STREQ("8: This is the eighth line",
                 entire_file.at(7).toStdString().c_str());
    EXPECT_STREQ("9: This is the ninth line",
                 entire_file.at(8).toStdString().c_str());
    EXPECT_STREQ("10: This is the tenth line",
                 entire_file.at(9).toStdString().c_str());
}

TEST_F(TextFileReaderTest, testReadSubsetOfFile) {
    // Grab the 2 lines of the file starting at the second line
    bump::StringList entire_file =
        bump::TextFileReader::fileContents(_validFileName, 2, 2);
    EXPECT_STREQ("2: This is the second line",
                 entire_file.at(0).toStdString().c_str());
    EXPECT_STREQ("3: This is the third line",
                 entire_file.at(1).toStdString().c_str());
...
TEST_F(TextFileReaderTest, testReadFromLineToEnd) {
    // Grab the 2 lines of the file starting at the second line
    bump::StringList entire_file =
        bump::TextFileReader::fileContents(_validFileName, 2);
    EXPECT_STREQ("2: This is the second line",
                 entire_file.at(0).toStdString().c_str());
    EXPECT_STREQ("3: This is the third line",
                 entire_file.at(1).toStdString().c_str());
...
TEST_F(TextFileReaderTest, testReadFirstLine) {
    // With a valid file path, invalids are taken care of in
    // testValidityOfFile()
    bump::String line = bump::TextFileReader::firstLine(_validFileName);
    EXPECT_STREQ("1: This is the first line", line.toStdString().c_str());
}
...
TEST_F(TextFileReaderTest, testHeader) {
    ...
    bump::StringList entire_file =
        bump::TextFileReader::header(_validFileName, 2);
    EXPECT_STREQ("1: This is the first line",
                 entire_file.at(0).toStdString().c_str());
    EXPECT_STREQ("2: This is the second line",
                 entire_file.at(1).toStdString().c_str());
...
TEST_F(TextFileReaderTest, testFooter) {
    ...
    bump::StringList entire_file =
        bump::TextFileReader::footer(_validFileName, 2);
    EXPECT_STREQ("9: This is the ninth line",
                 entire_file.at(0).toStdString().c_str());
    EXPECT_STREQ("10: This is the tenth line",
                 entire_file.at(1).toStdString().c_str());
