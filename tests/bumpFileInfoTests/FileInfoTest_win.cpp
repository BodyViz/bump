...
TEST_F(FileInfoTest, testIsReadableByUser) {
    EXPECT_THROW(bump::FileInfo("").isReadableByUser(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsWritableByUser) {
    EXPECT_THROW(bump::FileInfo("").isWritableByUser(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsExecutableByUser) {
    EXPECT_THROW(bump::FileInfo("").isExecutableByUser(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsReadableByOwner) {
    EXPECT_THROW(bump::FileInfo("").isReadableByOwner(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsWritableByOwner) {
    EXPECT_THROW(bump::FileInfo("").isWritableByOwner(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsExecutableByOwner) {
    EXPECT_THROW(bump::FileInfo("").isExecutableByOwner(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsReadableByGroup) {
    EXPECT_THROW(bump::FileInfo("").isReadableByGroup(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsWritableByGroup) {
    EXPECT_THROW(bump::FileInfo("").isWritableByGroup(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsExecutableByGroup) {
    EXPECT_THROW(bump::FileInfo("").isExecutableByGroup(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsReadableByOthers) {
    EXPECT_THROW(bump::FileInfo("").isReadableByOthers(),
                 bump::NotImplementedError);
}

TEST_F(FileInfoTest, testIsWritableByOthers) {
    EXPECT_THROW(bump::FileInfo("").isWritableByOthers(),
                 bump::NotImplementedError);
}
