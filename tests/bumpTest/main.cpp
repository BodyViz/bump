...
/**
 * This application consists of a full coverage set of unit tests for the
 * bump::String class. It uses the GTest framework to each possible runtime path
 * of every function in the String class.
 */
